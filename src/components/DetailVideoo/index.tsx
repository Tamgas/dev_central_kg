        ...
        <div className="container">
          <div className="video-down">
            ...
            <div className="video-down--text">
              ...
              <p>
                В гостях были: <br />· Хамбар Дусалиев — Head of ML & Operations
                at Kolesa Group <br /> · Камалхан Артыкбаев — Lead Computer
                vision Engineer at Parqour
              </p>
            </div>
          </div>
        </div>
